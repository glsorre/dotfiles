...
fpath+=( "$HOME/.cache/antidote/github.com/ohmyzsh/ohmyzsh/plugins/starship" )
source "$HOME/.cache/antidote/github.com/ohmyzsh/ohmyzsh/plugins/starship/starship.plugin.zsh"
...
fpath+=( "$HOME/.cache/antidote/github.com/ohmyzsh/ohmyzsh/plugins/python" )
source "$HOME/.cache/antidote/github.com/ohmyzsh/ohmyzsh/plugins/python/python.plugin.zsh"
fpath+=( "$HOME/.cache/antidote/github.com/ohmyzsh/ohmyzsh/plugins/pip" )
source "$HOME/.cache/antidote/github.com/ohmyzsh/ohmyzsh/plugins/pip/pip.plugin.zsh"
...
fpath+=( "$HOME/.cache/antidote/github.com/ohmyzsh/ohmyzsh/plugins/vscode" )
source "$HOME/.cache/antidote/github.com/ohmyzsh/ohmyzsh/plugins/vscode/vscode.plugin.zsh"
...
fpath+=( "$HOME/.cache/antidote/github.com/djui/alias-tips" )
source "$HOME/.cache/antidote/github.com/djui/alias-tips/alias-tips.plugin.zsh"
fpath+=( "$HOME/.cache/antidote/github.com/caarlos0/zsh-mkc" )
source "$HOME/.cache/antidote/github.com/caarlos0/zsh-mkc/mkc.plugin.zsh"
fpath+=( "$HOME/.cache/antidote/github.com/Tarrasch/zsh-bd" )
source "$HOME/.cache/antidote/github.com/Tarrasch/zsh-bd/bd.plugin.zsh"
